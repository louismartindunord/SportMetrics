...
from utils.form_user_page import create_user_form
...
def main(session_state):
    ...
    create_user_form(
        info_dict=connexion_infos,
        infos_type="connexion_info",
        tab_string="Vos informations de connexion",
    )

    create_user_form(
        info_dict=person_infos,
        infos_type="person_infos",
        tab_string="Vos informations Personnel",
    )
    # connexion_infos_tab: Sequence[DeltaGenerator] = st.tabs(tabs=["Vos informations de connexion"])
